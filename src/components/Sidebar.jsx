...
function Sidebar() {
  ...
  return (
    <div className="hidden sm:block sm:w-[16%] md:w-[14%] lg:w-[25%] h-[calc(100vh-6.625rem)] overflow-y-scroll overflow-x-hidden bg-white px-4">
      {/* Home */}
      ...
      <br />
      <p className="text-xs text-gray-500 mt-3">© 2024 Disha_siddaramu</p>
    </div>
  );
}
